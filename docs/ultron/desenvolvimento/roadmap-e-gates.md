...
### U4 — 🚧 Em desenvolvimento (fundação `fb283db`)
...
- 173 testes, 91,53% de cobertura, lint, tipagem e build aprovados

Pendente: grafo de manifests/instalações, busca/portal, retenção e integração cloud.
