...
### U2 — 🚧 Em desenvolvimento (fundação `a53877b`)
...
- 140 testes, 91,39% de cobertura, lint/formatação, tipagem de produção e build aprovados
- Pendente para o gate: coleta de conteúdo órfão, adapters e E2E do ciclo completo
